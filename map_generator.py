...
def generate_map_from_csv(subset_full_path):
    ...
    if "selected_smoothing_method" in df.columns:
        # Get the smoothing method from the DataFrame
        selected_method = df["selected_smoothing_method"].iloc[
            0]  # Assuming the same method applies to the entire DataFrame
    ...
    # 5B. OpenRailwayMap overlayslayers =
    orm_layers = {
